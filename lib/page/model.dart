...
class GameController extends GetxController {
  ...
  Future<void> swapWithAnim(Point<int> focusBlock,
      Point<int> targetBlock) async {
  ...
  Future<bool> eliminateAll(
      {bool byUser = false, VoidCallback? beforeEliminate}) async {
